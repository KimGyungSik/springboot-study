...
class ManyToOneTest {
    ...
    public void test() {
        ...
        user = userRepository.findById(user.getId()).orElse(null); // user정보만 조회
        System.out.println("user = " + user); // + board정보까지 조회
        System.out.println("user.getList() = " + user.getList()); // + board정보까지 조회
